...
<head>
    ...
    <style>
        body {
            ...
            /* FIX 1: Ensure body takes full height */
            min-height: 100vh;
            display: flex;
            flex-direction: column;
        }
        main { flex-grow: 1; } /* Main content expands */
...
<body class="antialiased">
    ...
    <main class="py-16">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-white p-8 md:p-12 rounded-3xl shadow-2xl border border-gray-100 transition-all duration-300">
    ...
    <footer class="text-center py-6 text-sm text-slate-500 bg-gray-100 border-t border-gray-200">
