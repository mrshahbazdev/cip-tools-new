<div class="max-w-md mx-auto bg-white p-8 rounded-xl shadow-lg border border-gray-100 mt-10">
    ...
    <form wire:submit.prevent="register" class="space-y-4">
        ...
        <div>
            ...
            <input type="email" wire:model="email" placeholder="user@{{ tenant('id') }}.com" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 transition">
